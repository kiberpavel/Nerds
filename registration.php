...
<head>
    ...
    <script src="vadidateReg.js"></script>
...
<header class="main__header">
    ...
    <section class="container-auto">
      <div class="auth-content">
        <form class="content" action="1.php" method="POST" onsubmit="return validateRegistration(this);">
          <div class="dws-input">
              <input type="text" placeholder="Введите имя" name="first_name" class="form__item__input--fname" >
              <span class="form__error">Введите корректное имя</span>
          </div>
          <div class="dws-input">
              <input type="text" placeholder="Введите фамилию" name="second_name" class="form__item__input--sname" >
              <span class="form__error">Введите корректную фамилию</span>
          </div>
          <div class="dws-input">
          ...
          <div class="reg-submit">
            <button type="submit" class="sub-login">Регистрация</button>
          </div>
